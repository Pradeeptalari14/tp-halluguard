...
> 轻量级 reasoning model fine-tuned for automated response factuality validation.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/halluguard/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-halluguard.git
cd tp-halluguard
```
...
```bash
kubectl port-forward deployment/tp-halluguard 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── hallucination_mitigator.py     # Main configuration file
```
...
---
*Generated by [HalluGuard Studio](https://pradeeptalari14.github.io/portfolio/tools/halluguard/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
